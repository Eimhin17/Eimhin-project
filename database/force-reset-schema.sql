-- =====================================================
-- DebsMatch FORCE RESET Database Schema
-- This script will DEFINITELY remove all existing tables
-- and create the new optimized schema
-- =====================================================

-- Step 1: Disable foreign key checks temporarily
SET session_replication_role = replica;

-- Step 2: Force drop ALL tables in the public schema
DO $$ 
DECLARE 
    r RECORD;
BEGIN
...
-- =====================================================
-- CREATE VOICE PROMPTS & AUDIO CONTENT TABLES
-- =====================================================
...
-- =====================================================
-- CREATE MATCHING & INTERACTION TABLES
-- =====================================================
...
-- =====================================================
-- CREATE MODERATION & SAFETY TABLES
-- =====================================================
...
-- This force reset script has:
-- ✅ Completely removed all existing tables
-- ✅ Created the optimized schema from scratch

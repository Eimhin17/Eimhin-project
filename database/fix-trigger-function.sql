...
-- This will resolve the profile creation issue during signup
...
BEGIN
  ...
  VALUES (
    NEW.id,
    NEW.email, -- Add the email field that's required
...
BEGIN
  ...
  RAISE NOTICE '3. Email field will be properly set';
END $$;

...
export default function MascotPhase3Screen() {
  // Animation values
  ...
  const handleBackPress = () => {
    ...
    Animated.parallel([
      ...
      safeGoBack(ONBOARDING_STEPS.MASCOT_PHASE3);
    });
  };
        ...
        >
          ...
          <Animated.View style={[styles.header, { opacity: fadeAnim }]}>
            ...
            <View style={styles.headerCenter}>
              <View style={styles.progressContainer}>
                <Text style={styles.progressText}>Phase 3</Text>
                <Text style={styles.progressSubtext}>Match preferences</Text>
              </View>
            </View>
          ...
          <Animated.View style={[styles.content, { opacity: contentOpacity }]}>
            <View style={styles.mascotContainer}>
              <Image
                source={require('../../Images/Phase 3 photo.png')}
...
const styles = StyleSheet.create({
  ...
  mascotContainer: {
    ...
    marginTop: 20, // Positive margin to move image lower
  },
  mascotImage: {

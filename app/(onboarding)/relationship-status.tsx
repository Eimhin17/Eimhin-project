...
export default function RelationshipStatusScreen() {
  ...
  useEffect(() => {
    setCurrentStep(ONBOARDING_STEPS.RELATIONSHIP_STATUS);
  }, []);
  ...
  const animateButtonSelection = (statusId: string) => {
  ...
  const handleStatusSelect = (statusId: string) => {
    ...
    animateButtonSelection(statusId);
    ...
    setTimeout(() => {
      Animated.timing(progressFillAnim, {
        ...
        setTimeout(async () => {
          ...
          try {
            await ProgressiveOnboardingService.updateProfile({ relationship_status: statusId });
          } catch (e) {
            console.warn('Relationship status save failed, continuing onboarding', e);
          }
  ...
  const handleBackPress = () => {
    ...
    Animated.parallel([
      ...
      safeGoBack(ONBOARDING_STEPS.RELATIONSHIP_STATUS);
    });
  };
        ...
        >
          ...
          >
            <View style={styles.headerSection}>
              <Text style={styles.title}>Relationship or...?</Text>

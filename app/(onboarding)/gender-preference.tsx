...
export default function GenderPreferenceScreen() {
  ...
  useEffect(() => {
    setCurrentStep(ONBOARDING_STEPS.GENDER_PREFERENCE);
  }, []);
      ...
      Animated.timing(progressFillAnim, {
        ...
        setTimeout(async () => {
          ...
          OnboardingService.storeTempData('basicDetails', {
            ...
            genderPreference: preferenceId
          });

          // Save immediately to profiles.match_preferences (JSONB)
          try {
            await ProgressiveOnboardingService.updateProfile({
              // Store gender preference under match_preferences JSONB
              // Note: This overwrites the JSON; if you later store more keys, consider merging
              match_preferences: { gender_preference: preferenceId } as any,
            });
          } catch (e) {
            console.warn('Gender preference save failed, continuing onboarding', e);
          }

          updateData({ genderPreference: preferenceId });
  ...
  const handleBackPress = () => {
    ...
    Animated.parallel([
      ...
      safeGoBack(ONBOARDING_STEPS.GENDER_PREFERENCE);
    });
  };
        ...
        >
          ...
          >
            <View style={styles.headerSection}>
              <Text style={styles.title}>Who would you like to match with?</Text>

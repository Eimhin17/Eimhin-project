        ...
        >
          ...
          <Animated.View style={[styles.header, { opacity: fadeAnim }]}>
            ...
            <View style={styles.headerCenter}>
              <Text style={styles.headerTitle}>Friends or more?</Text>
          ...
          <Animated.View style={[styles.content, { opacity: contentOpacity }]}>
            <View style={styles.illustrationContainer}>
              ...
              >
                <Ionicons name="search" size={40} color="#FF4F81" />
              </LinearGradient>
            </View>
            
            <Text style={styles.title}>What are you looking for?</Text>
            <Text style={styles.subtitle}>
              Are you looking for friends, dates, or both?
            </Text>
                ...
                >
                  ...
                  >
                    <Ionicons 
                      ...
                      size={24} 
                      color={selectedLookingFor === option.id ? '#FFFFFF' : '#c3b1e1'} 
                      style={styles.optionIcon}
                    />
                  <Text style={[
                    styles.optionLabel,
                    selectedLookingFor === option.id && styles.optionLabelActive
                  ]}>
                    {option.label}
                  </Text>
                  </LinearGradient>
